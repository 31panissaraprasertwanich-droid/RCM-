...
function initApp() {
  ...
  const savedFmea = localStorage.getItem('rcm_excel_data_v75');
  if (savedFmea) {
  ...
  const savedHi = localStorage.getItem('rcm_hi_data_v75');
  if (savedHi) {
...
function saveData() {
  ...
  localStorage.setItem('rcm_excel_data_v75', JSON.stringify(records));
  localStorage.setItem('rcm_hi_data_v75', JSON.stringify(hiRecords));
